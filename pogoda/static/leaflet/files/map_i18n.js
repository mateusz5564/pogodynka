...
function getI18n(key, lang) {
	var i18n = {
        ...
        pl: {
			...
			, rain: 'Deszcz'
			, raincls: 'Deszcz (classic)'
			, snow: 'Śnieg'
			, temp: 'Temperatura'
			, windspeed: 'Prędkośc wiatru'
			, pressure: 'Ciśnienie'
			, presscont: 'Ciśnienie kontur'

			, city: 'Miasto'
			, windrose: 'Róża wiartów'
...
function getLocalLanguage() {
	...
	if (lang != 'en' && lang != 'it' && lang != 'de' && lang != 'fr' && lang != 'ru' && lang != 'nl' && lang != 'ca' && lang != 'es' && lang != 'pt_br' && lang != 'pl') {
		lang = 'pl';
	}
	return lang;
}
